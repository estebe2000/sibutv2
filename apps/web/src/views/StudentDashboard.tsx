...
import { Container, Paper, Title, Text, Group, Stack, Badge, ThemeIcon, Alert, ActionIcon, Loader, Center, Divider, Accordion, FileInput, Button, Select, Menu, Tabs, Textarea } from '@mantine/core';
import { IconUser, IconSchool, IconInfoCircle, IconTimeline, IconFileText, IconDownload, IconBook, IconFolder, IconFileUpload, IconBriefcase, IconTrash, IconLock, IconPencil, IconPlus, IconHistory, IconPaperclip, IconCloudDownload, IconCompass, IconFileExport, IconDeviceFloppy } from '@tabler/icons-react';
      ...
      <Stack gap="lg">
        <Paper withBorder p="xl" radius="md" shadow="sm" bg="blue.0">
          <Group justify="space-between">
            ...
            <ThemeIcon size={60} radius="xl" variant="light" color="blue"><IconUser size={34} /></ThemeIcon>
          </Group>
        </Paper>

        <Tabs value={activeTab} onChange={setActiveTab} variant="pills" color="blue">
            <Tabs.List grow={isMobile}>
                <Tabs.Tab value="overview" leftSection={<IconTimeline size={16} />}>Mon Suivi</Tabs.Tab>
                <Tabs.Tab value="ppp" leftSection={<IconCompass size={16} />}>Mon PPP</Tabs.Tab>
                <Tabs.Tab value="export" leftSection={<IconFileExport size={16} />} color="orange">Exporter mon Book</Tabs.Tab>
            </Tabs.List>
                    ...
                    <Paper withBorder p="lg" radius="md" shadow="md">
                        <Group justify="space-between" mb="xl">
                            <Group>
                                ...
                                <div><Title order={3}>Mon Portfolio de Compétences</Title><Text size="sm" c="dimmed">Rédigez vos réflexions et liez vos preuves.</Text></div>
                            </Group>
