...
\textbf{Parcours :} MMPV \quad \textbf{Heures :} 12 heures

\subsection*{Descriptif}
Contribution au développement de la ou des compétences ciblées :
\begin{itemize}
  \item Comprendre la complexité des organisations
  \item Identiﬁer les principaux effets cognitifs, conatifs et affectifs de l’environnement professionnel sur les acteurs et leurs
\end{itemize}
...
Manager une équipe commerciale sur un espace de vente, Conduire les actions marketing
