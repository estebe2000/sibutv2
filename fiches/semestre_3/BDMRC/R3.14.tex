...
\textbf{Parcours :} BDMRC \quad \textbf{Heures :} 10 heures
...
Déﬁnir son proﬁl, en partant de ses appétences, de ses envies et asseoir son choix professionnel
\begin{itemize}
...
\begin{itemize}
  \item Identiﬁer les métiers associés au(x) projet(s) professionnel(s)
...
\begin{itemize}
  ...
  \item Identiﬁer les métiers possibles en fonction du parcours de B.U.T. choisi
\end{itemize}
