...
\textbf{Parcours :} BDMRC \quad \textbf{Heures :} 18 heures dont 8 heures de TP
...
S’informer et informer de manière critique et efﬁcace (niveau 3) :
\begin{itemize}
...
gestion des conﬂits).
\begin{itemize}
  \item Développer ses habiletés relationnelles en contexte de communication au travail (empathie, écoute, entretien, afﬁrmation
\end{itemize}
