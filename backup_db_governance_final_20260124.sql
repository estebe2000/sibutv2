...
\restrict paWM4Z2iQm0oWDU1sPSfafU7o2M95FSG1wRxTGninBjdRM6hPlh5ONbDOoaCUNk
...
13	10	2026 s2 stage	20	2025-2026
\.
...
81	BUT 1 - Gr A	1	Tronc Commun	FI	2025-2026
\.
...
COPY public.internship (id, student_uid, academic_year, start_date, end_date, company_name, company_address, company_phone, company_email, supervisor_name, supervisor_phone, supervisor_email, evaluation_token, token_expires_at, is_finalized, is_active) FROM stdin;
1	pytels	2025-2026	\N	\N	a	4 Rue du Maulévrier	0770052646	aaa@aaaa.fr	tom cruise	01 02 03 04 05	tomtom@for.ever	\N	\N	f	t
3	tdtd	2025-2026	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	f	t
\.
...
60	pytels	RESOURCE	R1.13	OWNER	2025-2026
\.
...
89	13	15	\N	Concevoir des OAV efficaces	\N	1
90	13	\N	\N	horraire	\N	1
91	13	\N	\N	serieux	\N	1
54	10	4	\N	Concevoir une offre cohérente et éthique en termes de produits, de prix, de distribution et de communication	\N	1
92	13	\N	\N	look	\N	1
88	13	16	\N	Évaluer la performance commerciale au moyen d'indicateurs	\N	2
76	13	1	\N	Analyser l'environnement d'une entreprise en repérant et appréciant les sources d'informations	\N	2
78	13	3	\N	Choisir une cible et un positionnement en fonction de la segmentation du marché	\N	2
...
77	13	2	\N	Mettre en oeuvre une étude de marché dans un environnement simple	\N	1
79	13	4	\N	Concevoir une offre cohérente et éthique en termes de produits, de prix, de distribution et de communication	\N	1
80	13	13	\N	Préparer un plan de découverte qui permette de profiler le client	\N	1
81	13	14	\N	Concevoir un argumentaire de vente adapté	\N	1
82	13	31	\N	Analyser les indicateurs post campagne	\N	1
83	13	30	\N	Élaborer des supports simples (ISA, affiches...)	\N	1
84	13	29	\N	Analyser de manière pertinente les moyens de communication	\N	1
85	13	28	\N	Identifier les cibles et objectifs de communication	\N	1
86	13	18	\N	Recourir aux codes d'expression spécifiques et professionnels	\N	1
87	13	17	\N	Recourir aux techniques adaptées à la démarche de prospection	\N	1
\.
...
366	tbtb	tbtb@univ-test.fr	Directeur Etude Tbtb	STUDY_DIRECTOR	1
367	tctc	tctc@univ-test.fr	Enseignant Tctc	PROFESSOR	1
363	tabellth	thierry.tabellion@univ-lehavre.fr	Thierry Tabellion	PROFESSOR	1
368	tdtd	tdtd@univ-test.fr	Etudiant Tdtd	STUDENT	81
365	tata	tata@univ-test.fr	Admin Tata	ADMIN	1
...
SELECT pg_catalog.setval('public.evaluationrubric_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.internship_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.internshipevaluation_id_seq', 68, true);
...
SELECT pg_catalog.setval('public.internshipvisit_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.responsibilitymatrix_id_seq', 60, true);
...
SELECT pg_catalog.setval('public.rubriccriterion_id_seq', 92, true);
...
\unrestrict paWM4Z2iQm0oWDU1sPSfafU7o2M95FSG1wRxTGninBjdRM6hPlh5ONbDOoaCUNk
